...
for color_num=1:3
    for threshold=0.1:0.01:0.2 %0.15
        for image_num=1:total_image
            load (['output/threshold_',num2str(threshold),'/image_',num2str(image_num),'/color_',num2str(color_num),'/data_image.mat']);        
            for worm_num=1:total_worms
                ...
                load (['output/threshold_',num2str(threshold),'/image_',num2str(image_num),'/color_',num2str(color_num),'/data_',num2str(worm_num),'.mat']);
                clear i k;
            ...
            %             end  %%
                ...
                clear cor_area j k;
                save (['output/threshold_',num2str(threshold),'/image_',num2str(image_num),'/color_',num2str(color_num),'/data_',num2str(worm_num),'.mat']);
            end
        end
    end
end
